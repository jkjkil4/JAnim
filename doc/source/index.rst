...
.. tabs::
    ...
    .. translatable-tab:: API 演示

        .. random-choice::

            .. include:: examples/_api_demonstration_options.rst

    .. translatable-tab:: 简单演示

        .. random-choice::
            :start-text: 🎲 点击“随机切换”显示一个样例
            :destroy:

            .. include:: examples/_simple_demonstration_options.rst

    .. translatable-tab:: 科普视频
    ...
    .. translatable-tab:: 音游铺面
        ...
        .. random-choice::
            ...
            .. include:: examples/_rhythm_game_options.rst

    .. translatable-tab:: 视频叠加演示

        .. random-choice::
            :start-text: 🎲 点击“随机切换”显示一个样例
            :destroy:

            .. include:: examples/_overlay_demonstration_options.rst
