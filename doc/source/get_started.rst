...
每次修改完都要手动重新构建可能还是有点麻烦了，JAnim 也提供了在保存时自动重新构建的功能：

.. tabs::

    .. translatable-tab:: 使用 VS Code 作为编辑器

        如果你使用 VS Code 开发，可以安装 VS Code 插件 ``janim-toolbox``
        ...
        .. tip::
            ...
            你也可以更改窗口放置的位置，或者显示到其它屏幕，另见 :ref:`window_position`
    ...
    .. translatable-tab:: 使用其它编辑器
        ...
        如果你使用其它编辑器，也提供了直接检测文件变更并自动重新构建的功能
        ...
        .. note::
            ...
            其实，无论使用什么编辑器，都可以用 ``--watch`` 参数监测文件变更
