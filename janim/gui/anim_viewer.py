try:
    ...
    from janim.logger import plog
    _ = get_local_strings('anim_viewer')

    plog.info(_('Additional modules need to be installed when using the GUI interface, but they are not installed'))
    plog.info(_('You can install them using pip install "janim[gui]" '
