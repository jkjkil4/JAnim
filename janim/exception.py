...
class TargetNotFoundError(AnimationError): ...
class UpdaterError(AnimationError): ...
...
class ShaderInjectionNotFoundError(JAnimException): ...

class GuiCommandError(JAnimException): ...

class MediaError(JAnimException): ...
